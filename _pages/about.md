...
I study how the choice of discretization shapes what geometric algorithms can compute and how robust they are. My recent work develops **discretizations of tangent vector fields** that are continuous, pointwise evaluatable, and have bounded derivatives. Since the discretization supports pointwise evaluation, I am keen to explore its use inside autodiff pipelines. I am also interested in **adaptive, hierarchical representations**, a crucial ingredient in efficient geometry processing, where I developed a multigrid-style solver over adaptive octrees for surface reconstruction from unoriented point clouds.
